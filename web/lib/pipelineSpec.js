...
export const NODES = [
  {
    ...
    howTo: {
      ...
      steps: [
        ...
        'Copy the key (it starts with sk- and is shown only once) and paste it below.',
        'Billing → add a small credit. A brand-new key with no credit returns “quota exceeded”.',
      ],
      note: 'gpt-4o-mini writes a full song for a fraction of a rupee. Pick a bigger model only if you want richer lyrics.',
    },
  },
  {
    id: 'song',
